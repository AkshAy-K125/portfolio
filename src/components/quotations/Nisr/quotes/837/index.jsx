      ...
      <div className="quote-document">
        ...
        <div className="section">
          ...
          <div className="table-container">
            <table className="quote-table">
              ...
              <tbody>
                <tr><td>Job Completion Certificate Status (Supervisor)</td><td>Implementation of job completion certificate status tracking system for supervisors</td><td>2</td></tr>
                <tr><td>Job Completion Certificate Status (Office)</td><td>Office panel integration to reflect job completion certificate status from supervisor system</td><td>2</td></tr>
              </tbody>
              <tfoot>
                <tr>
        ...
        <div className="section">
          ...
          <ul className="terms-list">
            <li><strong>1. Payment Schedule:</strong> Total cost is <strong>68 BHD</strong> (4 days × 17 BHD). Advance payment of <strong>40% (27.20 BHD)</strong> required; remaining <strong>60% (40.80 BHD)</strong> due upon completion.</li>
