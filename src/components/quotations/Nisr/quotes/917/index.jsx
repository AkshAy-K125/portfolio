      ...
      <div className="quote-document">
          ...
          <div className="table-container">
            <table className="quote-table">
              ...
              <tbody>
                ...
                <tr><td>Quotation Podium page revamp</td><td>Code revamp and improvement of the Quotation Podium page.</td><td>3</td></tr>
                <tr><td>Job Order Page revamp</td><td>Code revamp and improvement of the Job Order page.</td><td>2</td></tr>
                <tr><td>Invoice Page revamp</td><td>Code revamp and improvement of the Invoice page.</td><td>2</td></tr>
                <tr><td>LPO Page revamp</td><td>Code revamp and improvement of the LPO (Local Purchase Order) page.</td><td>1</td></tr>
                <tr><td>Warranty Page revamp</td><td>Code revamp and improvement of the Warranty page.</td><td>2</td></tr>
              </tbody>
              <tfoot>
                <tr>
        ...
        <div className="section">
          ...
          <ul className="terms-list">
            <li><strong>1. Payment Schedule:</strong> Total cost is <strong>221 BHD</strong> (13 days × 17 BHD). Advance payment of <strong>40% (88.40 BHD)</strong> required; remaining <strong>60% (132.60 BHD)</strong> due upon completion.</li>
