      ...
      <div className="quote-document">
        ...
        <header className="quote-header">
          ...
          <div className="quote-info">
            ...
            <p><strong>Quote #:</strong> Q-2026-1071</p>
            <p><strong>Date:</strong> June 3, 2026</p>
          </div>
        </header>
        ...
        <p>
          Thank you for the opportunity to discuss your project needs. I am excited to partner with you to
          enhance your platform. This document outlines the scope, timeline, and terms for the proposed
          feature development.
        </p>
        ...
        <div className="section">
          ...
          <div className="table-container">
            <table className="quote-table">
              ...
              <tbody>
                <tr>
                  <td>Costing Table Enhancement</td>
                  <td>
                    Update the costing table in the quotation system to include Shipping Cost and Finance
                    Cost as dedicated input fields, allowing users to enter and track these costs alongside
                    the existing development cost breakdown.
                  </td>
                  <td>2</td>
                </tr>
              </tbody>
          ...
          <p>The daily rate for this project is <strong>18 BHD</strong>.</p>
        </div>

        <div className="section">
          <h2 className="section-heading">Revisions</h2>
          <p>
            This quote includes three (3) minor revisions and one (1) major revision to ensure the final
        ...
        <div className="section">
          ...
          <p>
            ...
            support for the features once they have been delivered and accepted.
          </p>
        </div>
        ...
        <div className="section">
          ...
          <p>
            The project timeline will be established in a detailed plan once this quote is officially
            approved and the advance payment is received.
          </p>
        </div>
        ...
        <div className="section">
          ...
          <ul className="terms-list">
            <li><strong>1. Payment Schedule:</strong> Total cost is <strong>36 BHD</strong> (2 days × 18 BHD). Advance payment of <strong>60% (21.60 BHD)</strong> is required to initiate the project, with the remaining <strong>40% (14.40 BHD)</strong> due upon project completion.</li>
