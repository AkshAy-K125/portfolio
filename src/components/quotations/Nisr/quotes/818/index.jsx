      ...
      <div className="quote-document">
        ...
        <div className="section">
          ...
          <div className="table-container">
            <table className="quote-table">
              ...
              <tbody>
                <tr><td>Payment Widget</td><td>Integration of a user-facing widget for processing payments.</td><td>1</td></tr>
                <tr><td>Payment Receivables Page</td><td>Creation of a new administrative page to manage and track payment receivables.</td><td>5</td></tr>
                <tr><td>Job completion status with Note</td><td>Creation of a new widget to manage and track job completion status with Note field</td><td>2</td></tr>
                <tr><td>New Formatted report</td><td>Creation of a new formatted pdf/csv report</td><td>2</td></tr>
                <tr><td>Tax Toggle</td><td>Implementation of a toggle function to switch tax calculations on and off for LPOs.</td><td>1</td></tr>
              </tbody>
              <tfoot>
                <tr>
        ...
        <div className="section">
          ...
          <ul className="terms-list">
            <li><strong>1. Payment Schedule:</strong> Total cost is <strong>187 BHD</strong>. Advance payment of <strong>40% (74.80 BHD)</strong> required to initiate; remaining <strong>60% (112.20 BHD)</strong> due upon completion.</li>
