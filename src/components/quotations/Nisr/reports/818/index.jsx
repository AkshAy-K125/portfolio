      ...
      <div className="report-wrapper">
        ...
        <div className="report-content">
          ...
          <div className="tasks-container">
            <div className="feature-card">
              <div className="feature-header">
                ...
                <span className="effort-badge">Effort: 1 Day</span>
              </div>
            ...
            <div className="feature-card">
              <div className="feature-header">
                ...
                <span className="effort-badge">Effort: 5 Days</span>
              </div>
            ...
            <div className="feature-card">
              <div className="feature-header">
                ...
                <span className="effort-badge">Effort: 2 Days</span>
              </div>
          ...
          <footer className="report-footer">
            ...
            <p>Requesting you to please proceed with the remaining payment of 60% (112.20 BHD) within this settling date, failing of which would result in future projects requiring a 100% advance payment.</p>
          </footer>
        </div>
