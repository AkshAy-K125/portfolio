      ...
      <div className="quote-document">
        <header className="quote-header">
          ...
          <div className="quote-info">
            ...
            <p><strong>Quote #:</strong> Q-2026-917</p>
        ...
        <div className="section">
          ...
          <p>This quote covers the development and delivery of the following features:</p>
            ...
            <table className="quote-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Refactor and improve the Job Summary and Analysis Page codebase; include the new libraries and modules related to the current version of google open source code.</td>
                  <td>3</td>
                </tr>
                <tr>
                  <td>Quotation Podium page revamp</td>
                  <td>Code revamp and improvement of the Quotation Podium page.</td>
                  <td>3</td>
                </tr>
                <tr>
                  <td>Job Order Page revamp</td>
                  <td>Code revamp and improvement of the Job Order page.</td>
                  <td>2</td>
                </tr>
                <tr>
                  <td>Invoice Page revamp</td>
                  <td>Code revamp and improvement of the Invoice page.</td>
                  <td>2</td>
                </tr>
                <tr>
                  <td>LPO Page revamp</td>
                  <td>Code revamp and improvement of the LPO (Local Purchase Order) page.</td>
                  <td>1</td>
                </tr>
                <tr>
                  <td>Warranty Page revamp</td>
                  <td>Code revamp and improvement of the Warranty page.</td>
                  <td>2</td>
                </tr>
              </tbody>
              <tfoot>
        ...
        <div className="section">
          ...
          <ul className="terms-list">
            <li><strong>1. Payment Schedule:</strong> This is a fixed-fee project based on the total estimated effort. The total cost is <strong>221 BHD</strong> (13 days × 17 BHD). An advance payment of <strong>40% (88.40 BHD)</strong> is required to initiate the project, with the remaining <strong>60% (132.60 BHD)</strong> due upon project completion.</li>
