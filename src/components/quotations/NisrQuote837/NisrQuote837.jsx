      ...
      <div className="quote-document">
        <header className="quote-header">
          ...
          <div className="quote-info">
            ...
            <p><strong>Quote #:</strong> Q-2025-837</p>
        ...
        <div className="section">
          ...
          <div className="table-container">
            <table className="quote-table">
              ...
              <tbody>
                <tr>
                  <td>Job Completion Certificate Status (Supervisor)</td>
                  <td>Implementation of job completion certificate status tracking system for supervisors</td>
                  <td>2</td>
                </tr>
                <tr>
                  <td>Job Completion Certificate Status (Office)</td>
                  <td>Office panel integration to reflect job completion certificate status from supervisor system</td>
                  <td>2</td>
                </tr>
              </tbody>
              <tfoot>
        ...
        <div className="section">
          ...
          <ul className="terms-list">
            <li><strong>1. Payment Schedule:</strong> This is a fixed-fee project based on the total estimated effort. The total cost is <strong>68 BHD</strong> (4 days × 17 BHD). An advance payment of <strong>40% (27.20 BHD)</strong> is required to initiate the project, with the remaining <strong>60% (40.80 BHD)</strong> due upon project completion.</li>
